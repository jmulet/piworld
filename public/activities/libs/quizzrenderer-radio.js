 define([], function(){
    ...
    var quizzRendererRadio = function(question, container){
        ...
        $.each(question.options, function(i, o){
            ...
            template += '<input type="radio" id="radio'+that.id+'_'+i+'"';
            if(numValid===1){
                template+= ' name="quizzradio_'+that.id+'" ';
            }
    ...
    quizzRendererRadio.prototype =  {
        ...
        check: function(){
            ...
            $.each(this.question.options, function(i, o){                
                var selected = that.main.find('#radio'+that.id+'_'+i).prop("checked");
        ...
        revealAnswer: function(){
            ...
            $.each(this.question.options, function(i, o){                
               if(o.valid) {
                   $("#radio"+that.id+"_"+i).css({background: "green"});
               }
            });
        },
