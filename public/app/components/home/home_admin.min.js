...
{idAssignment:b.id}).then(function(){a.reload()})},function(){})};a.editAsgn=function(a){f.go("home.assignments",{idGroup:a.idGroup,idAssignment:a.id})};a.goAssignments=function(){f.go("home.assignments",{idGroup:0,idAssignment:0})};a.editUnit=function(a){a.edit=!0;a.unitbck=a.unit};a.cancelEditUnit=function(a){a.unit=a.unitbck;delete a.unitbck;a.edit=!1};a.saveEditUnit=function(a){c.post("/rest/unit/save",a).then(function(){delete a.unitbck;a.edit=!1})};a.go=function(b){f.go(b);"home"===b&&a.reload()};
a.showEquations=function(){c.post("/rest/oftheday/eqns").then(function(b){f.go("home");a.eqns=b.data})};a.showScore(1);h.adjustPadding()}])});
