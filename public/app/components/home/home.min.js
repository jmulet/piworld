...
window.pw.app.register.controller("HomeController",["HomeService","$scope","$rootScope","$state","$http","MyCacheService","$translate","USER_ROLES","$uibModal","$window","$timeout","Auth","Session","growl","Modals","$compile",function(l,a,q,m,n,c,p,e,r,b,s,v,f,g,w,z){function t(b){var k=0,d=a.selectedGroup;d&&("B"===d.groupStudies[0]?k=2:2<d.groupLevel&&(k=1),x.httpCache("all","oftheday/all",{idUser:a.user.id,level:k,lang:p.use(),idGroup:d.idGroup},b).then(function(d){a.randomEqn=d.eqn;a.randomQuote=
d.quote;a.challenge=d.problem}))}function u(a){return/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(a)}l.initialize();a.user=f.getUser();if(a.user){a.amStudent=a.user.idRole===e.student;a.amStudent&&a.user.idRole===e.parents||m.go("login");a.$on("changeGrp",function(b,k){a.selectedGroup=k.group;t(!0)});l=new Date;l.setDate(l.getDate()-180);a.currentYear=l.getFullYear()-2E3;var x=c.getCache("HomeCache",
!1);a.leftClass="col-md-3 col-lg-3";a.mainClass="col-md-9 col-lg-7";a.rightClass="col-md-12 col-lg-2";a.USER_ROLES=e;c=749<$("body").width();a.tgs={mobileShow:1,welcome:!0,score:c,recent:!0,assignments:!0,famouseqn:c,quote:c,problem:c,groups:0===a.user.groups.length,users:c,chat:!0,kahootID:1};a.changeAvatar=function(){var b=a.user,k=r.open({templateUrl:"app/shared/avatar-dlg.html",controller:["$scope","Upload",function(a,y){a.title="AVATARS";a.user=b;a.limits=[0,2E3,5E3];a.avatars=[];for(var c=0;63>
...
idLogin:a.user.idLogin,vscore:h.target.attributes.vscore.value||1,vseconds:0,resource:c})}};a.scrollToLastChat=function(){s(function(){jQuery(".chat-scroll").each(function(){var a=jQuery(this).find(".chat-entry").last();a&&a.offset()&&(pw.bowser.mobile?window.scrollTo(0,a.offset().top):jQuery("html").animate({scrollTop:a.offset().top},1E3))})},600)};a.scrollToTop=function(){s(function(){jQuery("html").scrollTop(0)},500)};a.changePwd=function(){var b=a.user.idRole===e.parents,c=r.open({templateUrl:"app/components/home/changepwd-dlg.html",
controller:["$scope",function(d){d.oldpwd="";d.newpwd="";d.newpwd2="";d.username=(b?"Familia de ":"")+a.user.username;d.ok=function(){v.checkPassword(d.oldpwd||"").then(function(b){b.ok?6>d.newpwd.trim().length?g.error("La longitud m\u00ednima de la contrasenya s\u00f3n 6 car\u00e0cters."):d.newpwd.trim()===a.user.email.trim()?g.error("La constrasenya ha d'esser diferent que el correu electr\u00f2nic"):(b=/[0-9]/,b.test(d.newpwd)?(b=/[a-z]/,b.test(d.newpwd)?d.newpwd!==d.newpwd2?g.error("Les contrasenyes no coincideixen."):
...
w.notificationdlg("Nova contrasenya","S'ha canviat satisfact\u00f2riament la contrasenya"+(b?" d'acc\u00e9s fam\u00edlia.":".")):g.warning("Ho sentim per\u00f2, no s'ha pogut canviar la contrasenya.")})})};u(a.user.email);a.collapse=function(a){a.collapsed=!a.collapsed;a.collapsed&&(a.showAll=!1)};a.toggleGlobalCollapse=function(){};a.tabMobile=function(b){4===b?(a.scrollToLastChat(),a.tgs.chatWarning=!1):a.scrollToTop();a.tgs["tab"+b]=!0;a.tgs.mobileShow=b};f.getSocket().on("chat-recieved",function(b){b.idUser!==
