...
define(["https://www.gstatic.com/charts/loader.js", "jquery-draggable", "mobile-dnd"], function(){  
    ...
    var i18n = {
        ca: {
            ...
            PROGRESSOF: "Seguiment de l'alumne/a",
        ...
        es:{
            ...
            GRADEN: "Nota negativa",
            GRADEP: "Nota positiva",
            PROGRESSOF: "Seguimento del alumno/a",
        ...
        en: {
            ...
            PROGRESSOF: "Progress of student",
   ...
   var showGrade = function(grade, lang){
    ...
    window.pw.app.register.controller('ParentsProgressController', [ '$scope', '$rootScope', 'Session', 
