...
window);window.pw=window.pw||{};window.pw.GEOGEBRA_ROOT="https://www.geogebratube.org/";window.pw.KATEXCSS="https://cdnjs.cloudflare.com/ajax/libs/KaTeX/0.8.3/katex.min.css";
...
"jquery-draggable":"assets/libs/jquery/jquery-draggable","mobile-dnd":"assets/libs/DragDropTouch",rateyo:"assets/libs/jquery/jquery.rateyo.min",katex:"https://cdnjs.cloudflare.com/ajax/libs/KaTeX/0.8.2/katex.min",katexauto:"https://cdnjs.cloudflare.com/ajax/libs/KaTeX/0.8.2/contrib/auto-render.min",jsxgraph:"https://cdnjs.cloudflare.com/ajax/libs/jsxgraph/0.99.6/jsxgraphcore",jsxgraphcore:"https://cdnjs.cloudflare.com/ajax/libs/jsxgraph/0.99.6/jsxgraphcore",appmin:"app.min",angular:"assets/libs/angular/angular.min",
...
angularanimate:"assets/libs/angular-animate/angular-animate.min",datetimepicker:"assets/libs/angular-ui-bootstrap-datetimepicker/datetimepicker",moment:"assets/libs/bootstrap-datetimepicker/moment-with-locales.min",fxpicklist:"assets/libs/picklist",multiple_select:"assets/libs/multiple-select/multiple-select.min",angular_tree:"assets/libs/angular-ui-tree/angular-ui-tree.min","angular-split-pane":"app/shared/split-pane/angular-split-pane",nztoggle:"assets/libs/nz-toggle/nz-toggle.min",fileupload:"assets/libs/ng-file-upload/ng-file-upload.min",
ngJSPanel:"assets/libs/jsPanel/angular-jspanel",jqJSPanel:"assets/libs/jsPanel/jquery.jspanel.min",jqui:"https://ajax.googleapis.com/ajax/libs/jqueryui/1.9.2/jquery-ui.min",mobile_detect:"assets/libs/mobile-detect.min",app:"app/app",routes:"app/app.routes",directives:"app/app.directives",factories:"app/app.factories",controllers:"app/app.controllers",filters:"app/app.filters",homeCtrl:"app/components/home/home",groupsCtrl:"app/components/groups/groups",studentsCtrl:"app/components/students/students",
progressController:"app/components/students/progressController",activityReviewCtrl:"app/components/activity/activityReview",activitySimpleCtrl:"app/components/activity/activitySimpleCtrl",activitySheetCtrl:"app/components/activity/activitySheet",activityEditCtrl:"app/components/activity/activityEditCtrl",activityIdeCtrl:"app/components/ide/activityIdeCtrl",assignCtrl:"app/components/assign/assignCtrl",assignmentsCtrl:"app/components/assign/assignmentsCtrl",mathjax:["https://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML?noext",
"assets/libs/MathJax/MathJax.js?config=TeX-AMS-MML_HTMLorMML"],mathlex:"assets/libs/mathlex/mathlex.min",mathwrapper:"assets/libs/mathquill-0.10.1/mathwrapper",geogebra:window.pw.GEOGEBRA_ROOT+"scripts/worksheet/general",geogebra2:window.pw.GEOGEBRA_ROOT+"scripts/deployggb",geogebra3:window.pw.GEOGEBRA_ROOT+"files/appComp/shared/min",geogebra4:window.pw.GEOGEBRA_ROOT+"files/appComp/shared/mathquillggb",videojs_core:["assets/js/video.js/5.14/video.min","https://vjs.zencdn.net/5.14/video"],videojs:"assets/js/video.js/5.14/videojs-plugins-all.min",
video_embed:"assets/js/video.js/ng-video-embed.min",tinymce:"assets/libs/tinymce/tinymce.min",ng_tinymce:"assets/libs/angular-ui-tinymce/dist/tinymce.min",highlight:"assets/libs/angular-highlight/highlight.pack",ng_highlight:"assets/libs/angular-highlight/angular-highlight",easeljs:["https://code.createjs.com/easeljs-0.8.2.min","assets/libs/createjs/easeljs-0.8.2.min"],tweenjs:"https://code.createjs.com/tweenjs-0.6.2.min",soundjs:"https://code.createjs.com/soundjs-0.6.2.min",preloadjs:"https://code.createjs.com/preloadjs-0.6.2.min",
createjs:["https://code.createjs.com/createjs-2015.11.26.min","assets/libs/createjs/createjs-2015.11.26.min"],creatine:"assets/libs/createjs/creatine-1.0.0.min",filesaver:"assets/libs/FileSaver.min",markermanager:"assets/libs/markermanager.min",gmaps:"https://maps.googleapis.com/maps/api/js?key=AIzaSyBQpymLIcE26vpzgp3u6w90OO_aVT1d1R8&noext",pokemath:"app/components/pokemath/pokemath"},shim:{mathjax:{exports:"MathJax",init:function(){MathJax.Hub.Config({messageStyle:"none",tex2jax:{inlineMath:[["$",
"$"],["\\(","\\)"]]},"HTML-CSS":{showMathMenu:!1}});MathJax.Hub.Configured();MathJax.Hub.Startup.onload();return MathJax}},underscorestring:{deps:["underscore"],exports:"_"},uiace:{deps:["ace"]},geogebra:{deps:["geogebra2","geogebra3","geogebra4"]},jsxgraph:{deps:["css!https://cdnjs.cloudflare.com/ajax/libs/jsxgraph/0.99.6/jsxgraph.css"]},jsxgraphcore:{deps:["css!https://cdnjs.cloudflare.com/ajax/libs/jsxgraph/0.99.6/jsxgraph.css"]},creatine:{deps:["createjs"]},jqui:{deps:["mobile_detect"]},jqJSPanel:{deps:["jqui"]},
ngJSPanel:{deps:["jqJSPanel"]},ng_tinymce:{deps:["tinymce"]},ng_highlight:{deps:["highlight"]},markermanager:{deps:["gmaps"]},pokemath:{deps:["markermanager"]},translate_cookies:{deps:["translate"]},translate_url:{deps:["translate"]},appmin:{deps:"uirouter uibootstrap oclazyload ngcookies ngsanitize translate_cookies translate_url angulargrowl".split(" ")},angular:{exports:"angular"},uirouter:{deps:["angular"]},uibootstrap:{deps:["angular"]},oclazyload:{deps:["angular"]},ngcookies:{deps:["angular"]},
ngsanitize:{deps:["angular"]},angularanimate:{deps:["angular"]},translate:{deps:["angular"]},angulargrowl:{deps:["angular"]},ng_idle:{deps:["angular"]},angularSortable:{deps:["angular"]},angular_locale1:{deps:["angular"]},angular_locale2:{deps:["angular"]},videojs:{deps:["videojs_core"]},underscore:{exports:"_"},katexauto:{deps:["katex"]},KAS:{deps:["underscore"]},mathpaint:{deps:["canvaspaint"]},mathquilleditor:{deps:["mathquill"],exports:"MQ"},mathinput:{deps:["mathquilleditor","mathpaint"]},"activity-quizz":{deps:["activity-bakejson",
"mobile-dnd"]}},baseUrl:"",waitSeconds:60});require(["socketio","appmin"],function(g){window.io=g;0===window.pw.grave?window.pw.app.init():console.log("PiWorld bootstrap cancelled due to grave errors: ",window.pw.grave)});
