...
window.VimeoAPI = {Player: t()}; //This is the replacement of froogaloop
 
(function (root, factory) {

    root.Vimeo = factory(window.videojs);
...
**/
      ...
      console.log("returns ", divWrapper);
      return divWrapper;
    },
    ...
    initPlayer: function() {
      ...
      if (this.vimeo && this.vimeo.unload) {
        console.log(this.vimeo && this.vimeo.unload);
        this.vimeo.unload();
        delete this.vimeo;
      }

      console.log("about to create player", self.iframe);
      self.vimeo = new VimeoAPI.Player(self.iframe);
      console.log("player");
      console.log(self.vimeo);
    ...
    //TRIGGER
    load : function(){},
    play : function(){ this.vimeo.play(); },
    pause : function(){ this.vimeo.pause(); },
    paused : function(){
