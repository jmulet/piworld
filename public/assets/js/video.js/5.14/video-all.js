...
function getElData(el) {
  if(!el){
      console.log("getElData Element is null!");
      return {};
  }
  var id = el[elIdAttr];
...
function hasElData(el) {
  if(!el){
      console.log("hasElData Element is null!");
      return false;
  }
  var id = el[elIdAttr];
...
//=====================================================================BEGIN YOUTUBE-TECH
  ...
  var Youtube = videojs.extend(Tech, {
    ...
    onPlayerStateChange: function(e) {
      ...
      switch (state) {
        ...
        case YT.PlayerState.CUED:  
           //Make sure that loadmetada contains a valid duration time before playback        
           this.trigger('loadedmetadata');
    ...
    getVideoData: function(){
        return this.ytPlayer? this.ytPlayer.getVideoData() : {};
    },
...
//  var Tech = videojs.getComponent('Tech');
  ...
  var Vimeo = videojs.extend(Tech, {
    ...
    createEl: function() {
      ...
      this.iframe.setAttribute('src', this.baseUrl + this.videoId + '?api=1&player_id=' + this.options_.techId + (this.options_.background?"&background=1":""));
...
(function($, videojs, undefined) {
   ...
   function registerVideoJsMarkersPlugin(options) {
      ...
      // setup the plugin after we loaded video's meta data (does not work for youtube)
      ...
      player.on("durationchange", function() {
          if(player.duration() && !initialized){
              initialize();
          }
      });
