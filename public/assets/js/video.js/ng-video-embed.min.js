...
a.idActivity+". No further points will be added."),H=0)});this.on("ended",function(){if(0<a.idActivity&&!a.playerVars.preview&&!a.videoRating)if(u)u.removeClass("vjs-hidden");else{var b=E.get("/assets/libs/video.js/pw-endposter.html");u=jQuery(b);g(u.contents())(a);x.append(u)}})});b.id=w;return b}}e.addCss("/assets/libs/video.js/5.14/video-js.min.css");e.addCss("/assets/libs/video.js/5.14/videojs-markers.min.css");K.css({"max-width":"80%",margin:"auto"});var w=Math.random().toString(36).slice(2);
a.playerId=w;a.isMobile=window.pw.isMobile();a.videoUrl=a.videoUrl||"https://www.youtube.com/watch?v="+a.videoId;var p=10,H=1,L=15E4,v=1,C=0,B=0,I=0,t=e.getUser(),D=t.idRole===f.parents,A=t.idRole===f.guest||D,J=t.idLogin,m=0,b,x,r,u,n;a.soundSupported=!1;if(a.questions&&a.soundSupported){pw.Sound.register({theme1:"/assets/sounds/theme.ogg",theme2:"/assets/sounds/answer_20sec.ogg",theme3:"/assets/sounds/answer_30sec.ogg",ok:"/assets/sounds/0236.ogg",wrong:"/assets/sounds/0899.ogg"});a.soundEnabled=
!1;var q=null;a.toggleSound=function(){a.soundEnabled=!a.soundEnabled;t.uopts.vqsound=a.soundEnabled?1:0;e.updateUopts();if(a.soundEnabled){var b=Math.round(2*Math.random())+1;q="theme"+b;pw.Sound.play("theme"+b,2,.3)}else pw.Sound.stop()}}D=a.activity||{};a.idActivity=D.id||0;a.idAssignment=D.idAssignment||0;if("string"===typeof a.questions)try{a.questions=JSON.parse(a.questions)}catch(h){}a.questions&&a.questions.length?(a.hasQuestions=!0,jQuery.each(a.questions,function(a,b){b.time=z(b.time);b.check=
0})):(L=3E4,a.hasQuestions=!1,a.questions=[{time:Math.floor(580*Math.random())+120,check:0,formulation:"Segueixes l'explicaci\u00f3?",type:"multiple",options:[]}]);a.notes&&jQuery.each(a.notes,function(a,b){b.time=z(b.time)});G();a.pg={isPlaying:!1,tgsQuestion:!0,total:"00:00",ellapsed:"00:00",remaining:"00:00",max:100,value:0};a.priv=!1;a.activity={vscore:0,vscorenow:0};a.state={fs:!1,cclass:"row",showQuestions:!1,qclass:"col-xs-12 col-md-4",mclass:"col-md-12",played:!1};a.play_pause=function(){b&&
(a.pg.isPlaying?b.pause():(a.deadManListener&&l.cancel(a.deadManListener),b.play()),a.pg.isPlaying=!a.pg.isPlaying)};a.toggleOpt=function(b){0===a.question.check&&(b.selected=!b.selected)};a.toggleQuestion=function(){a.pg.tgsQuestion=!a.pg.tgsQuestion;r.find(".vjs-questions-container").css("height",a.pg.tgsQuestion?"90%":"40px")};a.closeQuestions=function(){a.deadManListener&&l.cancel(a.deadManListener);r.addClass("vjs-hidden");b.controlBar.show();a.state.showQuestions=!1;a.state.qclass="col-xs-12 col-md-4";
a.state.mclass="col-md-12";C+=1;b.currentTime(b.currentTime()+.5);b.play();q&&(pw.Sound.stop(q),q="")};a.doCheck=function(){if(a.question.check)a.closeQuestions();else{var b=5;"input"===a.question.type?a.question.check=a.question.input==a.question.answer?1:-1:"multiple"===a.question.type&&(a.question.input="",a.question.answer="",a.question.check=1,jQuery.each(a.question.options,function(b,d){d.selected&&(a.question.input+=d.title+"; ");d.valid&&(a.question.answer+=d.title+"; ");d.valid&&d.selected?
d.check=1:d.valid||d.selected?(d.check=-1,a.question.check=-1):d.check=0}),b=Math.floor(5));a.soundEnabled&&q&&(pw.Sound.stop(q),q="");!A&&0<m&&a.hasQuestions&&(a.activity.vscorenow+=a.question.check*b,k.registerVisualizationQuizz({idV:m,formulation:a.question.formulation,answer:a.question.input,rightAnswer:a.question.answer,isValid:0<a.question.check,penalty:b}));a.deadManListener&&l.cancel(a.deadManListener)}};a.playerHeight=a.playerHeight||390;a.playerWidth=a.playerWidth||640;a.playerVars=a.playerVars||
{};a.onRateVideo=function(){k.setRating(a.idActivity,t.id,a.videoRating);u.addClass("vjs-hidden")};var V=a.$watchCollection("questions",function(e,c){b&&(jQuery.each(a.questions,function(a,b){b.time=z(b.time)}),G(),b.markers.reset(a.markers))}),W=a.$watchCollection("notes",function(e,c){b&&(jQuery.each(a.notes,function(a,b){b.time=z(b.time)}),G(),b.markers.reset(a.markers))});a.$watchCollection(["playerHeight","playerWidth"],function(){b&&a.playerWidth&&a.playerHeight&&b.setSize(a.playerWidth,a.playerHeight)});
l(function(){if(a.videoId||a.playerVars.list)b&&"function"===typeof b.dispose&&b.dispose(),require(["videojs"],function(a){window.videojs=window.videojs||a;b=U()})});a.gotoSource=function(){M.confirmdlg("Enlla\u00e7 extern","<p><b>ATENCI\u00d3!</b> Estau apunt de sortir de pw. No es comptaran punts de visualitzaci\u00f3.</p><p><b>SUGGERIMENT: </b>Deixau un comentari al canal youtube perqu\u00e8 el professor pugui saber que heu accedit al v\u00eddeo.</p><p>Voleu anar a youtube?</p>",function(){N.open(a.videoUrl,
"_blank")})};a.$on("$destroy",function(){V();W();a.deadManListener&&l.cancel(a.deadManListener);var e=K.find("iframe");e[0]&&(e[0].src="about:blank");b&&(b.dispose(),jQuery("#"+a.playerId).empty());pw.Sound.stop();$("button.vjs-fullscreen-control.vjs-control.vjs-button").off();window.pw.FScreen.setOnfullscreenchange(null)})}}}]);
